...
public class TransparentWindow : MonoBehaviour
{
    ...
    private void SetWindowTopApha(bool isTop, bool isApha)
    {
        ...
        if (isTop)
        {
            ...
            if (!isApha)
            {
                intExTemp &= ~(WS_EX_TRANSPARENT | WS_EX_LAYERED);
            }
            else
            {
                intExTemp |= (WS_EX_TRANSPARENT | WS_EX_LAYERED);
        ...
        else
        {
            ...
            if (isApha)
            {
                intExTemp |= (WS_EX_LAYERED | WS_EX_TRANSPARENT);
            }
            else
            {
                intExTemp &= ~(WS_EX_TRANSPARENT | WS_EX_LAYERED);
        ...
        if (isTop)
        {
            SetWindowPos(hwnd, HWND_TOPMOST, currentX, currentY, ResWidth, ResHeight, SWP_SHOWWINDOW);
        }
        else
        {
            SetWindowPos(hwnd, HWND_NOTOPMOST, currentX, currentY, ResWidth, ResHeight, SWP_SHOWWINDOW);
        }
